...
namespace Demo
{
    ...
    {
        public string  constr = @"Data Source=CRIBV-DNET26\SQLEXPRESS;Initial Catalog=MyDatabase;Integrated Security=True";
        ...
        private void AddNewRecordRowToGrid()
        {
            ...
            {
                DataTable dtCurrentTable = (DataTable)ViewState["Mytable"];
        ...
        {
            DataTable dtProductSold = (DataTable)ViewState["Mytable"];
            connection();
            //creating object of SqlBulkCopy
            SqlBulkCopy objbulk = new SqlBulkCopy(con);
            //assigning Destination table name
            objbulk.DestinationTableName = "Mytable";
